  ...
  try {
    ...
    const coverPage = [
      {
        stack: [
          ...
          {
            text: "Baxter is not bound by errors (including omissions)",
            style: "coverSubTitle2",
            alignment: "right",
          },
          {
            text: "The prices set forth herein are suggested only",
            style: "coverSubTitle2",
            alignment: "right",
          },
          {
          ...
          {
            text: "All Prices in US Dollars",
            style: "coverSubTitle3",
            alignment: "right",
          },
        ],
      },
    ...
    for (var i = 0; i < discounts.length; i++) {
      if (discounts[i].Product_Category === "EENT") {
        ...
        const gruposUnicosOrdenados = [
          ...new Set(dataLayout.map((item) => item.Group)),
        ]
          .filter(Boolean) // Eliminar valores nulos o undefined
          .sort((a, b) => {
            // Ordenar por el atributo Order_Group
            const orderA =
              dataLayout.find((item) => item.Group === a)?.Order_Group || 0;
            const orderB =
              dataLayout.find((item) => item.Group === b)?.Order_Group || 0;
      ...
      if (discounts[i].Product_Category === "Vision Care") {
        ...
        const dataLayout = data.filter(
          (objeto) => objeto.Category === "Vision Care"
        );
        const gruposUnicosOrdenados = [
          ...new Set(dataLayout.map((item) => item.Group)),
        ]
      ...
      if (discounts[i].Product_Category === "Endoscopy") {
        ...
        const dataLayout = data.filter(
          (objeto) => objeto.Category === "Endoscopy"
        );
        const gruposUnicosOrdenados = [
          ...new Set(dataLayout.map((item) => item.Group)),
        ]
      ...
      if (discounts[i].Product_Category === "Lighting") {
        ...
        const dataLayout = data.filter(
          (objeto) => objeto.Category === "Lighting"
        );
        const gruposUnicosOrdenados = [
          ...new Set(dataLayout.map((item) => item.Group)),
        ]
      ...
      if (discounts[i].Product_Category === "Cardiology") {
        ...
        const dataLayout = data.filter(
          (objeto) => objeto.Category === "Cardiology"
        );
        const gruposUnicosOrdenados = [
          ...new Set(dataLayout.map((item) => item.Group)),
        ]
      ...
      if (discounts[i].Product_Category === "Respiratory") {
        ...
        const dataLayout = data.filter(
          (objeto) => objeto.Category === "Respiratory"
        );
        const gruposUnicosOrdenados = [
          ...new Set(dataLayout.map((item) => item.Group)),
        ]
      ...
      if (discounts[i].Product_Category === "Womens Health") {
        ...
        const dataLayout = data.filter(
          (objeto) => objeto.Category === "Womens Health"
        );
        const gruposUnicosOrdenados = [
          ...new Set(dataLayout.map((item) => item.Group)),
        ]
      ...
      if (discounts[i].Product_Category === "Core Blood Pressure") {
        ...
        const dataLayout = data.filter(
          (objeto) => objeto.Category === "Core Blood Pressure"
        );
        const gruposUnicosOrdenados = [
          ...new Set(dataLayout.map((item) => item.Group)),
        ]
      ...
      if (discounts[i].Product_Category === "Stethoscopes") {
        ...
        const dataLayout = data.filter(
          (objeto) => objeto.Category === "Stethoscopes"
        );
        const gruposUnicosOrdenados = [
          ...new Set(dataLayout.map((item) => item.Group)),
        ]
      ...
      if (discounts[i].Product_Category === "Thermometry") {
        ...
        const dataLayout = data.filter(
          (objeto) => objeto.Category === "Thermometry"
        );
        const gruposUnicosOrdenados = [
          ...new Set(dataLayout.map((item) => item.Group)),
        ]
      ...
      if (discounts[i].Product_Category === "Flexiport") {
        ...
        const dataLayout = data.filter(
          (objeto) => objeto.Category === "Flexiport"
        );
        const gruposUnicosOrdenados = [
          ...new Set(dataLayout.map((item) => item.Group)),
        ]
      ...
      if (discounts[i].Product_Category === "ProBP 3400") {
        ...
        const dataLayout = data.filter(
          (objeto) => objeto.Category === "Connex ProBP 3400"
        );
        const gruposUnicosOrdenados = [
          ...new Set(dataLayout.map((item) => item.Group)),
        ]
      ...
      if (discounts[i].Product_Category === "ProBP 2000") {
        ...
        const dataLayout = data.filter(
          (objeto) => objeto.Category === "ProBP 2000"
        );
        const gruposUnicosOrdenados = [
          ...new Set(dataLayout.map((item) => item.Group)),
        ]
      ...
      if (discounts[i].Product_Category === "Home Health") {
        ...
        const dataLayout = data.filter(
          (objeto) => objeto.Category === "Home Health"
        );
        const gruposUnicosOrdenados = [
          ...new Set(dataLayout.map((item) => item.Group)),
        ]
      ...
      if (discounts[i].Product_Category === "CSM") {
        ...
        const dataLayout = data.filter(
          (objeto) => objeto.Category === "Connex Spot Monitor"
        );
        const gruposUnicosOrdenados = [
          ...new Set(dataLayout.map((item) => item.Group)),
        ]
      ...
      if (discounts[i].Product_Category === "CP50 ECG") {
        ...
        const dataLayout = data.filter(
          (objeto) => objeto.Category === "CP50 ECG"
        );
        const gruposUnicosOrdenados = [
          ...new Set(dataLayout.map((item) => item.Group)),
        ]
      ...
      if (discounts[i].Product_Category === "CP150 ECG") {
        ...
        const dataLayout = data.filter(
          (objeto) => objeto.Category === "CP150 ECG"
        );
        const gruposUnicosOrdenados = [
          ...new Set(dataLayout.map((item) => item.Group)),
        ]
      ...
      if (discounts[i].Product_Category === "PC-Based ECG") {
        ...
        const dataLayout = data.filter(
          (objeto) => objeto.Category === "PC-Based ECG"
        );
        const gruposUnicosOrdenados = [
          ...new Set(dataLayout.map((item) => item.Group)),
        ]
      ...
      if (discounts[i].Product_Category === "Spirometry") {
        ...
        const dataLayout = data.filter(
          (objeto) => objeto.Category === "Spirometry"
        );
        const gruposUnicosOrdenados = [
          ...new Set(dataLayout.map((item) => item.Group)),
        ]
      ...
      if (discounts[i].Product_Category === "Veterinary") {
        ...
        const dataLayout = data.filter(
          (objeto) => objeto.Category === "Veterinary"
        );
        const gruposUnicosOrdenados = [
          ...new Set(dataLayout.map((item) => item.Group)),
        ]
      ...
      if (discounts[i].Product_Category === "ABPM Systems") {
        ...
        const dataLayout = data.filter(
          (objeto) => objeto.Category === "ABPM Systems"
        );
        const gruposUnicosOrdenados = [
          ...new Set(dataLayout.map((item) => item.Group)),
        ]
      ...
      if (discounts[i].Product_Category === "Holter ECG Systems") {
        ...
        const dataLayout = data.filter(
          (objeto) => objeto.Category === "Holter ECG Systems"
        );
        const gruposUnicosOrdenados = [
          ...new Set(dataLayout.map((item) => item.Group)),
        ]
      ...
      if (discounts[i].Product_Category === "SPOT 4400") {
        ...
        const dataLayout = data.filter(
          (objeto) => objeto.Category === "SPOT 4400"
        );
        const gruposUnicosOrdenados = [
          ...new Set(dataLayout.map((item) => item.Group)),
        ]
      ...
      if (discounts[i].Product_Category === "Cardiology Welch Allyn") {
        ...
        const dataLayout = data.filter(
          (objeto) => objeto.Category === "Cardiology Welch Allyn"
        );
        const gruposUnicosOrdenados = [
          ...new Set(dataLayout.map((item) => item.Group)),
        ]
    ...
    /**
     * FLC Dynamic Printing of Terms and Conditions
     * AEGH -- 01/06/2025
     */
    if (printTerms) {
      var thermsOfDistributionLayout =
        await thermsOfDistribution.getThermsOfDistribution();
    ...
    for (var i = 0; i < discounts.length; i++) {
      ...
      if (discounts[i].Product_Category === "Core Blood Pressure") {
        var coreBloodPressureLayout =
          await coreBloodPressure.getCoreBloodPressure(data);
      ...
      if (discounts[i].Product_Category === "ProBP 3400") {
        var connexProBP3400Layout = await connexProBP3400.getConnexProBd3400(
          data
        );
      ...
      if (discounts[i].Product_Category === "CSM") {
        var connexSpotMonitorLayout =
          await connexSpotMonitor.getConnexSpotMonitor(data);
      ...
      if (discounts[i].Product_Category === "Holter ECG Systems") {
        var holterECGSystemsLayout = await holterECGSystems.getHolterECGSystems(
          data
        );
      ...
      if (discounts[i].Product_Category === "Cardiology Welch Allyn") {
        var cardiologyWelchAllynLayout =
          await cardiologyWelchAllyn.getCardiologyWelch(data);
                ...
                [
                  {
                    border: [false, false, false, false],
                    text:
                      "Latin America and Caribbean Price List - Effective " +
                      effectiveDate +
                      " (Rev.I)",
                    fillColor: "#001A72",
                    style: "footer",
    ...
    return (response = {
      data: {
        status: 0,
        message:
          "Se generó un error al intentar generar el PDF, intente de nuevo",
        pdfPath: "",
      },
    });
  }
