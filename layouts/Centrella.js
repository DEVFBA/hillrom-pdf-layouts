            ...
            table: {
                ...
                body: [
                    ...
                    [
                        ...
                        {text: '$16,134', style: 'textotabla', alignment: 'center'},
                        {text: '$16,134', style: 'textotabla', alignment: 'center'}, 
                        {text: '$16,134', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                        ...
                        {text: '$5,346', style: 'textotabla', alignment: 'center'}, 
                        {text: '-', style: 'textotabla', alignment: 'center'}
                    ],
                    [
                        {border: [false, false, false, false], text: '', style: ''},
                        ...
                        {text: '-', style: 'textotabla', alignment: 'center'},
                        {text: '-', style: 'textotabla', alignment: 'center'}, 
                        {text: '$24,880', style: 'textotabla', alignment: 'center'},  
                    ],
                    [
                        {border: [false, false, false, false], text: '', style: ''},
                        {text: 'LIST PRICE', style: 'textotablacolor', fillColor: '#154898'},
                        {text: '$16,134', style: 'textotablacolor', alignment: 'center', fillColor: '#154898'},
                        {text: '$21,480', style: 'textotablacolor', alignment: 'center', fillColor: '#154898'}, 
                        {text: '$41,013', style: 'textotablacolor', alignment: 'center', fillColor: '#154898'}, 
                    ],
                ]
            },
            layout: {
            ...
            table: {
                ...
                body: [
                    ...
                    [
                        ...
                        {text: '$18,953', style: 'textotabla', alignment: 'center'},
                        {text: '$18,953', style: 'textotabla', alignment: 'center'}, 
                        {text: '*', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                        ...
                        {text: '$19,536', style: 'textotabla', alignment: 'center'},
                        {text: '$19,536', style: 'textotabla', alignment: 'center'}, 
                        {text: '-', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                    ...
                    [
                        ...
                        {text: '$2,860', style: 'textotabla', alignment: 'center'},
                        {text: '$2,860', style: 'textotabla', alignment: 'center'}, 
                        {text: '-', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                        ...
                        {text: '$1,334', style: 'textotabla', alignment: 'center'},
                        {text: '$1,334', style: 'textotabla', alignment: 'center'}, 
                        {text: '-', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                        ...
                        {text: '$7,167', style: 'textotabla', alignment: 'center'},
                        {text: '$7,167', style: 'textotabla', alignment: 'center'}, 
                        {text: '-', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                        ...
                        {text: '$7,537', style: 'textotabla', alignment: 'center'},
                        {text: '$7,537', style: 'textotabla', alignment: 'center'}, 
                        {text: '-', style: 'textotabla', alignment: 'center'},  
                    ],
                    [
                        ...
                        {text: '$6,597', style: 'textotabla', alignment: 'center'},
                        {text: '$6,597', style: 'textotabla', alignment: 'center'}, 
                        {text: '-', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                        ...
                        {text: '$6,967', style: 'textotabla', alignment: 'center'},
                        {text: '$6,967', style: 'textotabla', alignment: 'center'}, 
                        {text: '-', style: 'textotabla', alignment: 'center'}, 
                    ]
                ]
            ...
            table: {
                ...
                body: [
                    ...
                    [
                        ...
                        {text: '$5,832', style: 'textotabla', alignment: 'center'},
                        {text: '$5,832', style: 'textotabla', alignment: 'center'}, 
                        {text: '$5,832', style: 'textotabla', alignment: 'center'}, 
                    ],
                ]
            ...
            table: {
                ...
                body: [
                    ...
                    [
                        ...
                        {text: '$1,461', style: 'textotabla', alignment: 'center'},
                        {text: '$1,461', style: 'textotabla', alignment: 'center'}, 
                        {text: '$1,461', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
            ...
            table: {
                ...
                body: [
                    ...
                    [
                        ...
                        {text: '$1,868', style: 'textotabla', alignment: 'center'},
                        {text: '$1,868', style: 'textotabla', alignment: 'center'}, 
                        {text: '$1,868', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                        ...
                        {text: '$2,549', style: 'textotabla', alignment: 'center'},
                        {text: '$2,549', style: 'textotabla', alignment: 'center'}, 
                        {text: '$2,549', style: 'textotabla', alignment: 'center'}, 
                    ],
                ]
            ...
            table: {
                ...
                body: [
                    ...
                    [
                        ...
                        {text: '$984', style: 'textotabla', alignment: 'center'},
                        {text: '$984', style: 'textotabla', alignment: 'center'}, 
                        {text: '$984', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                        ...
                        {text: '$7,631', style: 'textotabla', alignment: 'center'},
                        {text: '$7,631', style: 'textotabla', alignment: 'center'}, 
                        {text: '$7,631', style: 'textotabla', alignment: 'center'}, 
                    ],
                ]
            ...
            table: {
                ...
                body: [
                    ...
                    [
                        ...
                        {text: '$1,704', style: 'textotabla', alignment: 'center'},
                        {text: '$1,704', style: 'textotabla', alignment: 'center'}, 
                        {text: '*', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                        ...
                        {text: '$411', style: 'textotabla', alignment: 'center'},
                        {text: '$411', style: 'textotabla', alignment: 'center'}, 
                        {text: '*', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                        ...
                        {text: '$261', style: 'textotabla', alignment: 'center'},
                        {text: '$261', style: 'textotabla', alignment: 'center'}, 
                        {text: '$261', style: 'textotabla', alignment: 'center'}, 
                    ]
                ]
            ...
            table: {
                ...
                body: [
                    ...
                    [
                        ...
                        {text: '$564', style: 'textotabla', alignment: 'center'},
                        {text: '$564', style: 'textotabla', alignment: 'center'}, 
                        {text: '$564', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                        ...
                        {text: '$282', style: 'textotabla', alignment: 'center'},
                        {text: '$282', style: 'textotabla', alignment: 'center'}, 
                        {text: '$282', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                    ...
                    [
                        ...
                        {text: '$562', style: 'textotabla', alignment: 'center'},
                        {text: '$562', style: 'textotabla', alignment: 'center'}, 
                        {text: '$562', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                    ...
                    [
                        ...
                        {text: '$5,099', style: 'textotabla', alignment: 'center'},
                        {text: '$5,099', style: 'textotabla', alignment: 'center'}, 
                        {text: '$5,099', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                    ...
                    [
                        ...
                        {text: '$898', style: 'textotabla', alignment: 'center'},
                        {text: '$898', style: 'textotabla', alignment: 'center'}, 
                        {text: '$898', style: 'textotabla', alignment: 'center'}, 
                    ],
                ]
            ...
            table: {
                ...
                body: [
                    ...
                    [
                        ...
                        {text: '$13,484', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'CENTRELLAMAT', style: 'textotabla', alignment: 'center'},
                        ...
                        {text: '$14,052', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        ...
                        {text: '$14,752', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                    ...
                    [
                        ...
                        {text: '$727', style: 'textotabla', alignment: 'center'},
                    ]
                ]
            },
            layout: {
            ...
            table: {
                ...
                body: [
                    [
                        ...
                        {text: '$2,816', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'CENTRELLAACC', style: 'textotabla', alignment: 'center'},
                    ...
                    [
                        ...
                        {text: '$173', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'CENTRELLAACC', style: 'textotabla', alignment: 'center'},
                    ...
                    [
                        ...
                        {text: '$2,673', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'CENTRELLAACC', style: 'textotabla', alignment: 'center'},
                    ...
                    [
                        ...
                        {text: '$2,400', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'CENTRELLAACC', style: 'textotabla', alignment: 'center'},
                    ...
                    [
                        ...
                        {text: '$473', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'MISCACCESSORIES', style: 'textotabla', alignment: 'center'},
                    ...
                    [
                        ...
                        {text: '$244', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'MISCACCESSORIES', style: 'textotabla', alignment: 'center'},
                        {text: 'Transport Shelf', style: 'textotabla'},
                        {text: 'P7524A', style: 'textotabla', alignment: 'center'},
                        {text: '$547', style: 'textotabla', alignment: 'center'},
                    ]
                ]
            },
            layout: {
            ...
            table: {
                ...
                body: [
                    ...
                    [
                        ...
                        {text: '$4,960', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        ...
                        {text: '$2,655', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'CENTRELLAGCIUPG', style: 'textotabla', alignment: 'center'},
                        ...
                        {text: '$2,372', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'CENTRELLAGCIUPG', style: 'textotabla', alignment: 'center'},
                        ...
                        {text: '$2,511', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'CENTRELLAGCIUPG', style: 'textotabla', alignment: 'center'},
                        ...
                        {text: '$2,266', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        ...
                        {text: '$1,616', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'CENTRELLASAFEVIEWUPG', style: 'textotabla', alignment: 'center'},
                        {text: 'SafeView®+ 40" Comfort Edition Frame Upgrade Kit *', style: 'textotabla'},
            ...
            table: {
                ...
                body: [
                    ...
                    [
                        ...
                        {text: '$2,648', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'HRRRACTIVATION', style: 'textotabla', alignment: 'center'},
                        ...
                        {text: '$6,056', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'HRRRACTIVATION', style: 'textotabla', alignment: 'center'},
                        ...
                        {text: '$8,891', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                    ...
                    [
                        ...
                        {text: '$2,270', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'HRRREXTEND', style: 'textotabla', alignment: 'center'},
                        ...
                        {text: '$4,162', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'HRRREXTEND', style: 'textotabla', alignment: 'center'},
                    ...
                    [
                        ...
                        {text: '$7,188', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                    ...
                    [
                        ...
                        {text: '$8,513', style: 'textotabla', alignment: 'center'},
                    ],
                ]
            },
            layout: {
