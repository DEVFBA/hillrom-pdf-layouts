        ...
        "\n",
        {
            table: {
                ...
                body: [
                    ...
                    [
                        {text: 'Nurse Call with Active Nurse Call Button', style: 'textotablacentrella'},
                        {text: 'CNT-SNC', style: 'textotablacentrella', alignment: 'center'},
                        {text: '$846', style: 'textotablacentrella', alignment: 'center'},
                        {text: '$846', style: 'textotablacentrella', alignment: 'center'}, 
                        {text: '$846', style: 'textotablacentrella', alignment: 'center'}, 
                        {text: '$846', style: 'textotablacentrella', alignment: 'center'},
                        {text: '$846', style: 'textotablacentrella', alignment: 'center'}, 
                    ...
                    [
                        {text: 'Siderail Nurse Call, Universal TV and Lighting Controls', style: 'textotablacatoni'},
                        {text: 'CNT-NUL', style: 'textotablacentrella', alignment: 'center'},
                        {text: '$846', style: 'textotablacentrella', alignment: 'center'},
                        {text: '$846', style: 'textotablacentrella', alignment: 'center'}, 
                        {text: '$846', style: 'textotablacentrella', alignment: 'center'}, 
                        {text: '$846', style: 'textotablacentrella', alignment: 'center'},
                    ...
                    [
                        {text: 'Experience Pod - Basic (P7926A07)', style: 'textotablacatoni'},
                        {text: 'CNT-EXPODB', style: 'textotablacentrella', alignment: 'center'},
                        {text: '$1,061', style: 'textotablacentrella', alignment: 'center'},
                        {text: '$1,061', style: 'textotablacentrella', alignment: 'center'}, 
                        {text: '$1,061', style: 'textotablacentrella', alignment: 'center'}, 
                        {text: '$1,061', style: 'textotablacentrella', alignment: 'center'},
                        {text: '$1,061', style: 'textotablacentrella', alignment: 'center'}, 
                    ...
                    [
                        {text: 'Experience Pod - Standard (P7926A03/04/05/06) includes Pendant', style: 'textotablacatoni'},
                        {text: 'CNT-EXPOD2', style: 'textotablacentrella', alignment: 'center'},
                        {text: '$1,476', style: 'textotablacentrella', alignment: 'center'},
                        {text: '$1,476', style: 'textotablacentrella', alignment: 'center'}, 
                        {text: '$1,476', style: 'textotablacentrella', alignment: 'center'}, 
                        {text: '$1,476', style: 'textotablacentrella', alignment: 'center'},
                        {text: '$1,476', style: 'textotablacentrella', alignment: 'center'}, 
