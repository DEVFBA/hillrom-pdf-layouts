            ...
            table: {
                ...
                body: [
                    ...
                    [
                        ...
                        {text: '$15,220', style: 'textotabla', alignment: 'center'},
                        {text: '$15,220', style: 'textotabla', alignment: 'center'}, 
                        {text: '$15,220', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                        ...
                        {text: '$5,044', style: 'textotabla', alignment: 'center'}, 
                        {text: '-', style: 'textotabla', alignment: 'center'}
                    ],
                    [
                        {border: [false, false, false, false], text: '', style: ''},
                        ...
                        {text: '-', style: 'textotabla', alignment: 'center'},
                        {text: '-', style: 'textotabla', alignment: 'center'}, 
                        {text: '$23,471', style: 'textotabla', alignment: 'center'},  
                    ],
                    [
                        {border: [false, false, false, false], text: '', style: ''},
                        {text: 'LIST PRICE', style: 'textotablacolor', fillColor: '#546ce4'},
                        {text: '$15,220', style: 'textotablacolor', alignment: 'center', fillColor: '#546ce4'},
                        {text: '$20,264', style: 'textotablacolor', alignment: 'center', fillColor: '#546ce4'}, 
                        {text: '$38,692', style: 'textotablacolor', alignment: 'center', fillColor: '#546ce4'}, 
                    ],
                ]
            },
            layout: {
            ...
            table: {
                ...
                body: [
                    ...
                    [
                        ...
                        {text: '$17,880', style: 'textotabla', alignment: 'center'},
                        {text: '$17,880', style: 'textotabla', alignment: 'center'}, 
                        {text: '●', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                        ...
                        {text: '$18,430', style: 'textotabla', alignment: 'center'},
                        {text: '$18,430', style: 'textotabla', alignment: 'center'}, 
                        {text: '-', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                    ...
                    [
                        ...
                        {text: '$2,698', style: 'textotabla', alignment: 'center'},
                        {text: '$2,698', style: 'textotabla', alignment: 'center'}, 
                        {text: '-', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                        ...
                        {text: '$1,259', style: 'textotabla', alignment: 'center'},
                        {text: '$1,259', style: 'textotabla', alignment: 'center'}, 
                        {text: '-', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                        ...
                        {text: '$6,761', style: 'textotabla', alignment: 'center'},
                        {text: '$6,761', style: 'textotabla', alignment: 'center'}, 
                        {text: '-', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                        ...
                        {text: '$7,111', style: 'textotabla', alignment: 'center'},
                        {text: '$7,111', style: 'textotabla', alignment: 'center'}, 
                        {text: '-', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        ...
                        {text: '$6,224', style: 'textotabla', alignment: 'center'},
                        {text: '$6,224', style: 'textotabla', alignment: 'center'}, 
                        {text: '-', style: 'textotabla', alignment: 'center'},  
                    ],
                    [
                        ...
                        {text: '$6,573', style: 'textotabla', alignment: 'center'},
                        {text: '$6,573', style: 'textotabla', alignment: 'center'}, 
                        {text: '-', style: 'textotabla', alignment: 'center'}, 
                    ],
                ]
            ...
            table: {
                ...
                body: [
                    ...
                    [
                        ...
                        {text: '$5,502', style: 'textotabla', alignment: 'center'},
                        {text: '$5,502', style: 'textotabla', alignment: 'center'}, 
                        {text: '$5,502', style: 'textotabla', alignment: 'center'}, 
                    ],
                ]
            ...
            table: {
                ...
                body: [
                    ...
                    [
                        ...
                        {text: '$1,378', style: 'textotabla', alignment: 'center'},
                        {text: '$1,378', style: 'textotabla', alignment: 'center'}, 
                        {text: '$1,378', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
            ...
            table: {
                ...
                body: [
                    ...
                    [
                        ...
                        {text: '$1,762', style: 'textotabla', alignment: 'center'},
                        {text: '$1,762', style: 'textotabla', alignment: 'center'}, 
                        {text: '$1,762', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                        ...
                        {text: '$2,405', style: 'textotabla', alignment: 'center'},
                        {text: '$2,405', style: 'textotabla', alignment: 'center'}, 
                        {text: '$2,405', style: 'textotabla', alignment: 'center'}, 
                    ],
                ]
            ...
            table: {
                ...
                body: [
                    ...
                    [
                        ...
                        {text: '$928', style: 'textotabla', alignment: 'center'},
                        {text: '$928', style: 'textotabla', alignment: 'center'}, 
                        {text: '$928', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                        ...
                        {text: '$7,199', style: 'textotabla', alignment: 'center'},
                        {text: '$7,199', style: 'textotabla', alignment: 'center'}, 
                        {text: '$7,199', style: 'textotabla', alignment: 'center'}, 
                    ],
                ]
            ...
            table: {
                ...
                body: [
                    ...
                    [
                        ...
                        {text: '$251', style: 'textotabla', alignment: 'center'},
                        {text: '●', style: 'textotabla', alignment: 'center'}, 
                        {text: '●', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                    ...
                    [
                        ...
                        {text: '$1,608', style: 'textotabla', alignment: 'center'},
                        {text: '$1,608', style: 'textotabla', alignment: 'center'}, 
                        {text: '●', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                        ...
                        {text: '$387', style: 'textotabla', alignment: 'center'},
                        {text: '$387', style: 'textotabla', alignment: 'center'}, 
                        {text: '●', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                        ...
                        {text: '$246', style: 'textotabla', alignment: 'center'},
                        {text: '$246', style: 'textotabla', alignment: 'center'}, 
                        {text: '$246', style: 'textotabla', alignment: 'center'}, 
                    ]
                ]
            ...
            table: {
                ...
                body: [
                    ...
                    [
                        ...
                        {text: '$426', style: 'textotabla', alignment: 'center'},
                        {text: '$426', style: 'textotabla', alignment: 'center'}, 
                        {text: '$426', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                        ...
                        {text: '$532', style: 'textotabla', alignment: 'center'},
                        {text: '$532', style: 'textotabla', alignment: 'center'}, 
                        {text: '$532', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                    ...
                    [
                        ...
                        {text: '$162', style: 'textotabla', alignment: 'center'},
                        {text: '$162', style: 'textotabla', alignment: 'center'}, 
                        {text: '$162', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                        ...
                        {text: '$530', style: 'textotabla', alignment: 'center'},
                        {text: '$530', style: 'textotabla', alignment: 'center'}, 
                        {text: '$530', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                    ...
                    [
                        ...
                        {text: '$4,811', style: 'textotabla', alignment: 'center'},
                        {text: '$4,811', style: 'textotabla', alignment: 'center'}, 
                        {text: '$4,811', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                        ...
                        {text: '$223', style: 'textotabla', alignment: 'center'},
                        {text: '$223', style: 'textotabla', alignment: 'center'}, 
                        {text: '$223', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
            ...
            table: {
                ...
                body: [
                    ...
                    [
                        ...
                        {text: '$12,721', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'CENTRELLAMAT', style: 'textotabla', alignment: 'center'},
                        ...
                        {text: '$13,256', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        ...
                        {text: '$13,917', style: 'textotabla', alignment: 'center'},
                    ],
                    [
            ...
            table: {
                ...
                body: [
                    [
                        ...
                        {text: '$2,657', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'CENTRELLAACC', style: 'textotabla', alignment: 'center'},
                    ...
                    [
                        ...
                        {text: '$163', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'CENTRELLAACC', style: 'textotabla', alignment: 'center'},
                        ...
                        {text: '$258', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'CENTRELLAACC', style: 'textotabla', alignment: 'center'},
                    ...
                    [
                        ...
                        {text: '$446', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'MISCACCESSORIES', style: 'textotabla', alignment: 'center'},
                    ...
                    [
                        ...
                        {text: '$516', style: 'textotabla', alignment: 'center'},
                    ]
                ]
            },
            layout: {
            ...
            table: {
                ...
                body: [
                    ...
                    [
                        ...
                        {text: '$586', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                    ...
                    [
                        ...
                        {text: '$4,679', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        ...
                        {text: '$2,505', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'CENTRELLAGCIUPG', style: 'textotabla', alignment: 'center'},
                        ...
                        {text: '$2,237', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'CENTRELLAGCIUPG', style: 'textotabla', alignment: 'center'},
                        ...
                        {text: '$2,369', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'CENTRELLAGCIUPG', style: 'textotabla', alignment: 'center'},
                        ...
                        {text: '$2,100', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        ...
                        {text: '$1,525', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'CENTRELLASAFEVIEWUPG', style: 'textotabla', alignment: 'center'},
                        {text: 'SafeView®+ 40" Comfort Edition Frame Upgrade Kit *', style: 'textotabla'},
            ...
            table: {
                ...
                body: [
                    ...
                    [
                        ...
                        {text: '$2,498', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'HRRRACTIVATION', style: 'textotabla', alignment: 'center'},
                        ...
                        {text: '$5,713', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'HRRRACTIVATION', style: 'textotabla', alignment: 'center'},
                        ...
                        {text: '$8,388', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                    ...
                    [
                        ...
                        {text: '$2,142', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'HRRREXTEND', style: 'textotabla', alignment: 'center'},
                        ...
                        {text: '$3,926', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'HRRREXTEND', style: 'textotabla', alignment: 'center'},
                    ...
                    [
                        ...
                        {text: '$6,782', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                    ...
                    [
                        ...
                        {text: '$8,031', style: 'textotabla', alignment: 'center'},
                    ],
                ]
            },
            layout: {
