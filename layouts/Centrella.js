    ...
    var centrella = [
            ...
            table: {
                ...
                body: [
                    [
                        ...
                        {border: [false, false, false, false], text: ''},
                        {border: [false, false, false, false], text: 'CENTRELLABED', style: 'textotablacolor', fillColor: '#546ce4', colSpan: 3,  alignment: 'center'},
                        {},
                        {}
                    ],
                    [
                    ...
                    [
                        ...
                        {border: [false, false, false, false], text: '', style: ''},
                        {text: 'CNT-BASE', style: 'textotablacolor', fillColor: '#546ce4', alignment: 'center'},
                        {text: 'CNT-PAK255', style: 'textotablacolor', fillColor: '#546ce4', alignment: 'center'}, 
                        {text: 'CNT-PAK355', style: 'textotablacolor', fillColor: '#546ce4', alignment: 'center'}, 
                    ],
                    [
                        {border: [false, false, false, false], text: '', style: ''},
                        {text: 'Centrella™ Base Bed - (does not include Verbal Alerts or USB)', style: 'textotabla'},
                        {text: '$15,283.52', style: 'textotabla', alignment: 'center'},
                        {text: '$15,283.52', style: 'textotabla', alignment: 'center'}, 
                        {text: '$15,283.52', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                        ...
                        {text: '$5,064.64', style: 'textotabla', alignment: 'center'}, 
                        {text: '-', style: 'textotabla', alignment: 'center'}
                    ],
                    [
                        {border: [false, false, false, false], text: '', style: ''},
                        ...
                        {text: '-', style: 'textotabla', alignment: 'center'},
                        {text: '-', style: 'textotabla', alignment: 'center'}, 
                        {text: '$23,568.16', style: 'textotabla', alignment: 'center'},  
                    ],
                    [
                        {border: [false, false, false, false], text: '', style: ''},
                        {text: 'LIST PRICE', style: 'textotablacolor', fillColor: '#546ce4'},
                        {text: '$15,283.52', style: 'textotablacolor', alignment: 'center', fillColor: '#546ce4'},
                        {text: '$20,348.16', style: 'textotablacolor', alignment: 'center', fillColor: '#546ce4'}, 
                        {text: '$38,851.68', style: 'textotablacolor', alignment: 'center', fillColor: '#546ce4'}, 
                    ],
                ]
            },
            layout: {
        ...
        "\n",
        {
            table: {
                ...
                body: [
                    [
                        {text: 'OPTION CODE', style: 'textotablacolor', fillColor: '#546ce4'},
                        {text: 'DESCRIPTION', style: 'textotablacolor', alignment: 'center', fillColor: '#546ce4'},
                        {text: 'CNT-BASE', style: 'textotablacolor', alignment: 'center', fillColor: '#546ce4'},
                        {text: 'CNT-PAK255', style: 'textotablacolor', alignment: 'center', fillColor: '#546ce4'}, 
                        {text: 'CNT-PAK355', style: 'textotablacolor', alignment: 'center', fillColor: '#546ce4'}, 
                    ],
                    [
                    ...
                    [
                        {text: 'AIR-36', style: 'textotabla', alignment: 'center'},
                        {text: 'Centrella™ MAX Air Surface - For 36" Frame', style: 'textotabla'},
                        {text: '$17,954.72', style: 'textotabla', alignment: 'center'},
                        {text: '$17,954.72', style: 'textotabla', alignment: 'center'}, 
                        {text: '●', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                        {text: 'AIR-40', style: 'textotabla', alignment: 'center'},
                        {text: "Centrella™ MAX Air Surface - For 40'' Frame", style: 'textotabla'},
                        {text: '$18,506.88', style: 'textotabla', alignment: 'center'},
                        {text: '$18,506.88', style: 'textotabla', alignment: 'center'}, 
                        {text: '-', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                        {text: 'AIR-40', style: 'textotabla', alignment: 'center'},
                        {text: 'Centrella™ MAX Air Surface Upgrade  - For 40" Frame', style: 'textotabla'},
                        {text: '-', style: 'textotabla', alignment: 'center'},
                        {text: '-', style: 'textotabla', alignment: 'center'}, 
                        {text: '$553.28', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'NPAIR-36', style: 'textotabla', alignment: 'center'},
                        {text: 'Centrella™ PRO Surface - For 36" Frame - P7921A01', style: 'textotabla'},
                        {text: '$2,157.12', style: 'textotabla', alignment: 'center'},
                        {text: '$2,157.12', style: 'textotabla', alignment: 'center'}, 
                        {text: '-', style: 'textotabla', alignment: 'center'},  
                    ],
                    [
                        {text: 'NPAIR-40', style: 'textotabla', alignment: 'center'},
                        {text: 'Centrella™ PRO Surface - For 40" Frame - P7921A02', style: 'textotabla'},
                        {text: '$2,709.28', style: 'textotabla', alignment: 'center'},
                        {text: '$2,709.28', style: 'textotabla', alignment: 'center'}, 
                        {text: '-', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                        {text: 'FOAM-36', style: 'textotabla', alignment: 'center'},
                        {text: 'Centrella™ CORE Surface - For 36" Frame - P7920A', style: 'textotabla'},
                        {text: '$1,263.36', style: 'textotabla', alignment: 'center'},
                        {text: '$1,263.36', style: 'textotabla', alignment: 'center'}, 
                        {text: '-', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                        {text: 'PP3', style: 'textotabla', alignment: 'center'},
                        {text: 'Centrella® Pro+ Surface 36" without X-RAY - P7923A03', style: 'textotabla'},
                        {text: '$6,789.44', style: 'textotabla', alignment: 'center'},
                        {text: '$6,789.44', style: 'textotabla', alignment: 'center'}, 
                        {text: '-', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                        {text: 'PP3X', style: 'textotabla', alignment: 'center'},
                        {text: 'Centrella® Pro+ Surface 36" with X-RAY - P7923A01', style: 'textotabla'},
                        {text: '$7,140.00', style: 'textotabla', alignment: 'center'},
                        {text: '$7,140.00', style: 'textotabla', alignment: 'center'}, 
                        {text: '-', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'PP4', style: 'textotabla' , alignment: 'center'},
                        {text: 'Centrella® Pro+ Surface 40" without X-RAY - P7923A04', style: 'textotabla'},
                        {text: '$6,249.60', style: 'textotabla', alignment: 'center'},
                        {text: '$6,249.60', style: 'textotabla', alignment: 'center'}, 
                        {text: '-', style: 'textotabla', alignment: 'center'},  
                    ],
                    [
                        {text: 'PP4X', style: 'textotabla', alignment: 'center'},
                        {text: 'Centrella® Pro+ Surface 40" with X-RAY - P7923A02', style: 'textotabla'},
                        {text: '$6,600.16', style: 'textotabla', alignment: 'center'},
                        {text: '$6,600.16', style: 'textotabla', alignment: 'center'}, 
                        {text: '-', style: 'textotabla', alignment: 'center'}, 
                    ],
                ]
            ...
            table: {
                ...
                body: [
                    ...
                    [
                        ...
                        {text: '$5,524.96', style: 'textotabla', alignment: 'center'},
                        {text: '$5,524.96', style: 'textotabla', alignment: 'center'}, 
                        {text: '$5,524.96', style: 'textotabla', alignment: 'center'}, 
                    ],
                ]
            ...
            table: {
                ...
                body: [
                    ...
                    [
                        ...
                        {text: '$1,384.32', style: 'textotabla', alignment: 'center'},
                        {text: '$1,384.32', style: 'textotabla', alignment: 'center'}, 
                        {text: '$1,384.32', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
            ...
            table: {
                ...
                body: [
                    ...
                    [
                        ...
                        {text: '$1,769.60', style: 'textotabla', alignment: 'center'},
                        {text: '$1,769.60', style: 'textotabla', alignment: 'center'}, 
                        {text: '$1,769.60', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                        ...
                        {text: '$2,414.72', style: 'textotabla', alignment: 'center'},
                        {text: '$2,414.72', style: 'textotabla', alignment: 'center'}, 
                        {text: '$2,414.72', style: 'textotabla', alignment: 'center'}, 
                    ],
                ]
            ...
            table: {
                ...
                body: [
                    ...
                    [
                        ...
                        {text: '$931.84', style: 'textotabla', alignment: 'center'},
                        {text: '$931.84', style: 'textotabla', alignment: 'center'}, 
                        {text: '$931.84', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                        ...
                        {text: '$7,228.48', style: 'textotabla', alignment: 'center'},
                        {text: '$7,228.48', style: 'textotabla', alignment: 'center'}, 
                        {text: '$7,228.48', style: 'textotabla', alignment: 'center'}, 
                    ],
                ]
            ...
            table: {
                ...
                body: [
                    ...
                    [
                        ...
                        {text: '$252.00', style: 'textotabla', alignment: 'center'},
                        {text: '●', style: 'textotabla', alignment: 'center'}, 
                        {text: '●', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                    ...
                    [
                        ...
                        {text: '$1,613.92', style: 'textotabla', alignment: 'center'},
                        {text: '$1,613.92', style: 'textotabla', alignment: 'center'}, 
                        {text: '●', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                        ...
                        {text: '$388.64', style: 'textotabla', alignment: 'center'},
                        {text: '$388.64', style: 'textotabla', alignment: 'center'}, 
                        {text: '●', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                        ...
                        {text: '$246.40', style: 'textotabla', alignment: 'center'},
                        {text: '$246.40', style: 'textotabla', alignment: 'center'}, 
                        {text: '$246.40', style: 'textotabla', alignment: 'center'}, 
                    ]
                ]
            ...
            table: {
                ...
                body: [
                    ...
                    [
                        ...
                        {text: '$427.84', style: 'textotabla', alignment: 'center'},
                        {text: '$427.84', style: 'textotabla', alignment: 'center'}, 
                        {text: '$427.84', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                        ...
                        {text: '$534.24', style: 'textotabla', alignment: 'center'},
                        {text: '$534.24', style: 'textotabla', alignment: 'center'}, 
                        {text: '$534.24', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                        ...
                        {text: '$266.56', style: 'textotabla', alignment: 'center'},
                        {text: '$266.56', style: 'textotabla', alignment: 'center'}, 
                        {text: '$266.56', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                        ...
                        {text: '$163.52', style: 'textotabla', alignment: 'center'},
                        {text: '$163.52', style: 'textotabla', alignment: 'center'}, 
                        {text: '$163.52', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                        ...
                        {text: '$532.00', style: 'textotabla', alignment: 'center'},
                        {text: '$532.00', style: 'textotabla', alignment: 'center'}, 
                        {text: '$532.00', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                        ...
                        {text: '$265.44', style: 'textotabla', alignment: 'center'},
                        {text: '$265.44', style: 'textotabla', alignment: 'center'}, 
                        {text: '$265.44', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                        ...
                        {text: '$4,830.56', style: 'textotabla', alignment: 'center'},
                        {text: '$4,830.56', style: 'textotabla', alignment: 'center'}, 
                        {text: '$4,830.56', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                        ...
                        {text: '$224.00', style: 'textotabla', alignment: 'center'},
                        {text: '$224.00', style: 'textotabla', alignment: 'center'}, 
                        {text: '$224.00', style: 'textotabla', alignment: 'center'}, 
                    ],
                    [
                        ...
                        {text: '$850.08', style: 'textotabla', alignment: 'center'},
                        {text: '$850.08', style: 'textotabla', alignment: 'center'}, 
                        {text: '$850.08', style: 'textotabla', alignment: 'center'}, 
                    ],
                ]
        ...
        { text: '\n', style: 'parrafo' },
        {
            table: {
                ...
                body: [
                    [
                        {text: 'KIT NAME', style: 'textotablacolorlarge', fillColor: '#546ce4', alignment: 'center'},
                    ...
                    [
                        ...
                        {text: '$12,773.60', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'CENTRELLAMAT', style: 'textotabla', alignment: 'center'},
                        ...
                        {text: '$13,311.20', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        ...
                        {text: '$13,974.24', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                    ...
                    [
                        ...
                        {text: '$7,140', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'PROPLUS', style: 'textotabla', alignment: 'center'},
                    ...
                    [
                        ...
                        {text: '$688.80', style: 'textotabla', alignment: 'center'},
                    ]
                ]
            },
            layout: {
            ...
            table: {
                ...
                body: [
                    [
                        ...
                        {text: '$2,667.84', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'CENTRELLAACC', style: 'textotabla', alignment: 'center'},
                    ...
                    [
                        ...
                        {text: '$258.72', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'CENTRELLAACC', style: 'textotabla', alignment: 'center'},
                    ...
                    [
                        ...
                        {text: '$2,532.32', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'CENTRELLAACC', style: 'textotabla', alignment: 'center'},
                    ...
                    [
                        ...
                        {text: '$2,273.60', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'CENTRELLAACC', style: 'textotabla', alignment: 'center'},
                    ...
                    [
                        ...
                        {text: '$232.96', style: 'textotabla', alignment: 'center'},
                    ],
                    [
            ...
            table: {
                ...
                body: [
                    ...
                    [
                        ...
                        {text: '$5,376', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'CENTRELLA40UPG', style: 'textotabla', alignment: 'center'},
                        {text: 'SafeView®+ 40" Comfort Edition Frame Upgrade Kit *', style: 'textotabla'},
                        {text: 'P7933A10', style: 'textotabla', alignment: 'center'},
                        {text: '$1,541.12', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'CENTRELLAACC', style: 'textotabla', alignment: 'center'},
                        {text: 'Intellidrive™ Powered Transport Upgrade Kit *', style: 'textotabla'},
                        {text: 'P7933A01', style: 'textotabla', alignment: 'center'},
                        {text: '$7,033.60', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'CENTRELLAACC', style: 'textotabla', alignment: 'center'},
                        {text: 'Sidecom Upgrade Kit', style: 'textotabla'},
                        {text: 'P7933A16', style: 'textotabla', alignment: 'center'},
                        {text: '$2,509.92', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'CENTRELLAACC', style: 'textotabla', alignment: 'center'},
                    ...
                    [
                        ...
                        {text: '$4,698.40', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        ...
                        {text: '$2,515.52', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'CENTRELLAGCIUPG', style: 'textotabla', alignment: 'center'},
                        ...
                        {text: '$2,246.72', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'CENTRELLAGCIUPG', style: 'textotabla', alignment: 'center'},
                        ...
                        {text: '$2,378.88', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'CENTRELLAGCIUPG', style: 'textotabla', alignment: 'center'},
                        ...
                        {text: '$2,108.96', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        ...
                        {text: '$1,531.04', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'CENTRELLASAFEVIEWUPG', style: 'textotabla', alignment: 'center'},
                        {text: 'SafeView®+ 40" Comfort Edition Frame Upgrade Kit *', style: 'textotabla'},
            ...
            table: {
                ...
                body: [
                    ...
                    [
                        ...
                        {text: '$2,508.80', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'HRRRACTIVATION', style: 'textotabla', alignment: 'center'},
                        ...
                        {text: '$5,736.64', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'HRRRACTIVATION', style: 'textotabla', alignment: 'center'},
                        ...
                        {text: '$8,422.40', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                    ...
                    [
                        ...
                        {text: '$2,150.40', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'HRRREXTEND', style: 'textotabla', alignment: 'center'},
                        ...
                        {text: '$3,942.40', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'HRRREXTEND', style: 'textotabla', alignment: 'center'},
                        ...
                        {text: '$5,376.00', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                        {text: 'HRRREXTEND', style: 'textotabla', alignment: 'center'},
                        ...
                        {text: '$6,809.60', style: 'textotabla', alignment: 'center'},
                    ],
                    [
                    ...
                    [
                        ...
                        {text: '$8,064.00', style: 'textotabla', alignment: 'center'},
                    ],
                ]
            },
            layout: {
