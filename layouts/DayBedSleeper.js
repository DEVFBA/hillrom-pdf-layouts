            ...
            columns: [
                {
                    ...
                    table: {
                        ...
                        body: [
                            ...
                            [
                                {border: [false, false, false, false], text: ''},
                                {text: 'PREMIUMDAYBED', style: 'textotablacolor', fillColor: '#154898',  alignment: 'center'},
                                {text: 'PREMIUMTRIMLINEDAYBED', style: 'textotablacolor', fillColor: '#154898',  alignment: 'center'},
                            ],
                            [
                                {border: [false, false, false, false], text: ''},
                            ...
                            [
                                {border: [false, false, false, false], text: ''},
                                {text: 'SLPA', style: 'textotablacolor', fillColor: '#154898',  alignment: 'center'},
                                {text: 'SLPS', style: 'textotablacolor', fillColor: '#154898',  alignment: 'center'},
                            ],
                            [
                            ...
                            [
                                {text: 'Three Cushion Sofa with Convertible Sleep Surface', style: 'textotablacolor', fillColor: '#154898'},
                                {text: '*', style: 'textotablacolor', alignment: 'center', fillColor: '#154898'},
                                {text: '*', style: 'textotablacolor', alignment: 'center', fillColor: '#154898'}, 
                            ],
                            [
