...
async function getProgressa()
{
    ...
    if(pulmonaryIntegrated.length > 0)
    {
        /*ESTO VA EN UN CICLO*/
    ...
    var table2 = [];
    if(patientSiderail.length > 0 || mobility.length > 0 || permanentPole.length > 0 || transportShelf.length > 0)
    {
        table2 = [
            {
                table: {
    ...
    var table3 = [];
    if(accumaxSurfaces.length > 0 || therapyIntegrated.length > 0 || pulmonaryIntegrated.length > 0)
    {
        table3 = [
            {
                table: {
