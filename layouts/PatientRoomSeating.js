        ...
        { text: 'Patient Room Seating - Metropolitan™', style: 'subheader' },
        {
            table: {
                ...
                body: [
                    ...
                    [
                        {border: [false, false, false, false], text: ''},
                        {text: 'PREMIUMHIGHBACK', style: 'textotablacolor', fillColor: '#154898',  alignment: 'center'},
                        {text: 'PREMIUMVISITOR', style: 'textotablacolor', fillColor: '#154898',  alignment: 'center'},
                    ],
                    [
                        {border: [false, false, false, false], text: ''},
        ...
        },
        {
            table: {
                ...
                body: [
                    [
                        {border: [false, false, false, false], text: ''},
                        {text: 'VISM', style: 'textotablacolor', fillColor: '#154898',  alignment: 'center'},
                        {text: 'VI3M', style: 'textotablacolor', fillColor: '#154898',  alignment: 'center'},
                        {text: 'HIGM', style: 'textotablacolor', fillColor: '#154898',  alignment: 'center'},
                    ],
                    [
