            ...
            columns: [
                {
                    ...
                    table: {
                        ...
                        body: [
                            ...
                            [
                                {border: [false, false, false, false], text: ''},
                                {text: 'PREMIUMRECLINER', style: 'textotablacolor', fillColor: '#546ce4',  alignment: 'center', colSpan: 2},
                                {},
                            ],
                            [
                                {border: [false, false, false, false], text: ''},
            ...
            columns: [
                {
                    ...
                    table: {
                        ...
                        body: [
                            [
                                {border: [false, false, false, false], text: ''},
                                {text: 'R3SM', style: 'textotablacolor', fillColor: '#546ce4',  alignment: 'center'},
                                {text: 'R33M', style: 'textotablacolor', fillColor: '#546ce4',  alignment: 'center'},
                                {text: 'R3SR', style: 'textotablacolor', fillColor: '#546ce4',  alignment: 'center'},
                                {text: 'R33R', style: 'textotablacolor', fillColor: '#546ce4',  alignment: 'center'},
                            ],
                            [
