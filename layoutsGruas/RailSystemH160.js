...
async function getRailSystemH160(pdfZone)
{
    ...
    if(salida12.length > 0 || salida13.length > 0 || salida14.length > 0 || salida15.length > 0)
    {
        table1 = [
            {
                table: {
    ...
    var railSystemH160 = [
        ...
        "\n",
        {
            table: {
                ...
                body: [
                    [
                        {text: 'Rail System H160-180', style: 'textotablacolorlarge', fillColor: '#03857d',  alignment: 'center', tocItem: "railsystemh160"},
                    ]
                ]
            },
            layout: {
